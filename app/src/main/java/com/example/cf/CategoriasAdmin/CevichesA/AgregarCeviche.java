   ...
   // int CODIGO_DE_SOLICITUD_IMAGEN =5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null){
            ...
            //setear
            NombrePlatillosCeviche.setText(rNombre);
            PrecioPlatillosCeviches.setText(rPrecio);
            ...
            PublicarPlatilloCeviche.setText(actualizar);
        ...
        PublicarPlatilloCeviche.setOnClickListener(new View.OnClickListener(){
            @Override
                    public void onClick(View view){
                    if (PublicarPlatilloCeviche.getText().equals("Publicar")){
                        SubirImagen();
                    }else{
    ...
    private void EliminarImagenAnterior() {
        ...
        imagen.delete().addOnSuccessListener(new  OnSuccessListener<Void>() {
            ...
            //si la imagen se elimino
                Toast.makeText(AgregarCeviche.this, "La imagen anterior a sido eliminada ", Toast.LENGTH_SHORT).show();
                SubirNuevaImgen();
            }
    ...
    private void SubirNuevaImgen() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AgregarCeviche.this, "Nueva imagen cargada", Toast.LENGTH_SHORT).show();
    ...
    private void ActualizarImagenDB(final String nuevaImagen) {
        final String nombreActualizar = NombrePlatillosCeviche.getText().toString();
        final String precioActualizar = PrecioPlatillosCeviches.getText().toString();
        final int precioInt = Integer.parseInt(precioActualizar);
        final String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();

        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("PLATILLOS_CEEVICHE");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    Ceviche cevichelActual = ds.getValue(Ceviche.class);
                    ...
                    papeleraRef.child(idPapelera).setValue(cevichelActual);
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(AgregarCeviche.this, "Actualizado correctamente", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressDialog.dismiss();
                Toast.makeText(AgregarCeviche.this, "Error al actualizar la base de datos", Toast.LENGTH_SHORT).show();
            }
        });
    }
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Ceviche ceviche = new Ceviche(downloadUri, mNombre, PRECIO, uid);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(AgregarCeviche.this, "Cancelado", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
