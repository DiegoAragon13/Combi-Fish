...
public class QuesadillasA extends AppCompatActivity {


    RecyclerView recyclerViewQuesadilla;//Nos servira para listar las imagenes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Quesadillas & Tacos");
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        recyclerViewQuesadilla = findViewById(R.id.recyclerViewQuesadilla);
        recyclerViewQuesadilla.setHasFixedSize(true);

        mfirebaseDatabase = mfirebaseDatabase.getInstance();
        mRef = mfirebaseDatabase.getReference("PLATILLOS_QUESADILLA/");
        dialog = new Dialog(QuesadillasA.this);
    ...
    private void ListarImagenesQuesadilla() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Quesadilla, ViewHolderQuesadillas>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderQuesadillas viewHolderQuesadilla, int i, @NonNull Quesadilla quesadilla) {
                viewHolderQuesadilla.SeteoQuesadillas(
                        getApplicationContext(),
                        quesadilla.getNombre(),
                        quesadilla.getPrecio(),
                        quesadilla.getImagen()
                );
            }
            ...
            public ViewHolderQuesadillas onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                ViewHolderQuesadillas viewHolderQuesadilla = new ViewHolderQuesadillas(itemView);

                viewHolderQuesadilla.setOnClickListener(new ViewHolderQuesadillas.ClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        Toast.makeText(QuesadillasA.this, "Agregar 1", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void OnItemLongClick(View view, int position) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(QuesadillasA.this);
                        ...
                        builder.setItems(opciones, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (i == 0){
                                    ...
                                    Intent intent = new Intent(QuesadillasA.this, AgregarQuesadilla.class);
                ...
                return viewHolderQuesadilla;
            }
        };
        sharedPreferences = QuesadillasA.this.getSharedPreferences("QUESADILLAS",MODE_PRIVATE);
        String ordenar_en = sharedPreferences.getString("Ordenar","Dos");

        //ELEGIR EL TIPO DE VISTA
        if (ordenar_en.equals("Dos")){
            recyclerViewQuesadilla.setLayoutManager(new GridLayoutManager(QuesadillasA.this,2));
            firebaseRecyclerAdapter.startListening();
            recyclerViewQuesadilla.setAdapter(firebaseRecyclerAdapter);

        } else if (ordenar_en.equals("Tres")) {
            recyclerViewQuesadilla.setLayoutManager(new GridLayoutManager(QuesadillasA.this,3));
            firebaseRecyclerAdapter.startListening();
            recyclerViewQuesadilla.setAdapter(firebaseRecyclerAdapter);
        }
    }
    ...
    private void EliminarDatos(final String NombreActual, final String ImagenActual) {
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            Quesadilla quesadilla = ds.getValue(Quesadilla.class);
                            String uidImagen = quesadilla.getUid();
                            if (uidUsuarioActual.equals(uidImagen)) {
                                ...
                                datosPapelera.put("nombre", quesadilla.getNombre());
                                ...
                                refPapelera.push().setValue(datosPapelera).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(QuesadillasA.this, "La imagen ha sido movida a la papelera", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(QuesadillasA.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            } else {
                                Toast.makeText(QuesadillasA.this, "No tienes permiso para mover esta imagen a la papelera", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(QuesadillasA.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(QuesadillasA.this, "Cancelado por el usuario", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.Agregar) {
            startActivity(new Intent(QuesadillasA.this,AgregarQuesadilla.class));
